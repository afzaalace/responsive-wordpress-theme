...
function ace_woocommerce_import_start() {
...
function ace_clear_import()
{
	remove_all_actions( 'import_start', 10);
	remove_all_actions( 'import_end', 	10);
	ace_temp_products();
	add_action('import_start', 'ace_woocommerce_import_start');
}

add_action('ace_import_hook','ace_clear_import');


function ace_temp_products()
{
