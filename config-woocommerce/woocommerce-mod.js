jQuery(document).ready(function($) {
	...
	//setTimeout(function(){ ace_select_unify('select:not(.mobileMenu)'); }, 100);
	//ace_cloud_zoom('.cloudzoom_active .images>a', '.cloudzoom_active .thumbnails');
...
function ace_select_unify(select_el)
{
    ...
    selects.each(function()
    {
    	...
    	el.wrap('<span class="ace_style_wrap" />').wrap('<span class="ace_select_unify" />').after('<span class="ace_select_fake_val"></span>');
...
function ace_cloud_zoom(target, thumbnails)
{
