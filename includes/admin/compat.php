...
if(!function_exists('ace_backend_compatibility_featured_image'))
{
	/*
	...
	*/
	...
	function ace_backend_compatibility_featured_image($post_id, $result)
	{	
	...
	add_action('ace_meta_box_save_post','ace_backend_compatibility_featured_image',10,2);
}


if(!function_exists('ace_backend_compatibility_custom_field_filter'))
{
	/*
	...
	*/
	...
	function ace_backend_compatibility_custom_field_filter($custom_fields, $post_id)
	{	
	...
	add_filter('ace_meta_box_filter_custom_fields','ace_backend_compatibility_custom_field_filter',10,2);
	add_filter('ace_post_meta_filter','ace_backend_compatibility_custom_field_filter',10,2);
}

if(!function_exists('ace_get_post_by_title'))
{	
	function ace_get_post_by_title($post_title)
	{
