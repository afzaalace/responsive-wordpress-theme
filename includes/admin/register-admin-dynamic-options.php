...
$elements[] =	array(	
	...
	//start column	
	$column_element[] = array(	"slug"	=> "", "type" => "visual_group_start", "id" => "vg".$i, "nodescription" => true, 'class'=>'ace_pseudo_sortable', "required" => array('dynamic_column_count','{higher_than}'.$requirement) );
	...
	$column_element[] = array(	
		...
		"class" => 'ace_dynamic_template_widget',
		"desc" 	=> "",
