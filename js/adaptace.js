...
(function($)
{
	$.fn.ace_base_control_hide = function() 
	{
...
(function($)
{
	$.fn.ace_external_controls = function() 
	{
		return this.each(function()
		{
			var container 	= $(this).parent();
...
(function($)
{
	var aceGlobalCount = 0

	$.fn.aceImagePreloader = function(variables, callback) 
	{
		var defaults = 
		{
			fadeInSpeed: 800,
		...
		aceGlobalCount = aceGlobalCount + this.find('img').length;
		return this.each(function()
		{
			var container 	= $(this),
			...
			var methods = 
			{
				...
				{	
					currentImage.animate({opacity:1}, options.fadeInSpeed, function()
					{
						...
						{
							if(aceGlobalCount == 0) { $(window).trigger('ace_images_loaded'); }
			...
			if(!images.length) { methods.callback(); if(aceGlobalCount == 0) { $(window).trigger('ace_images_loaded'); } return }
