var scnDialogHelper = {
    ...
    loadShortcodeDetails: function () {
        if (scnSelectedShortcodeType) {
            var a = this;
            jQuery.getScript(ace_framework_globals.frameworkUrl + "php/ace_shortcodes/sc/" + scnSelectedShortcodeType + ".js", function () {
                a.initializeDialog()
            })
        }
    },
    ...
    previewAction: function (a) {
        ...
        jQuery("#scn-preview-iframe").attr("src", ace_framework_globals.frameworkUrl + "php/ace_shortcodes/preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()))
    },
