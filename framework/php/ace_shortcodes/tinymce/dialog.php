...
$shortcode_css = ACE_BASE_URL.'css/shortcodes.css';
...
<script type="text/javascript" src="<?php echo ACE_PHP_URL."ace_shortcodes/tinymce/js/column-control.js";?>"></script>
<script type="text/javascript" src="<?php echo ACE_PHP_URL."ace_shortcodes/tinymce/js/tab-control.js";?>"></script>
...
<script type="text/javascript" src="<?php echo ACE_PHP_URL."ace_shortcodes/tinymce/js/dialog.js";?>"></script>
